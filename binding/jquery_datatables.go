...
import (
	...
	"github.com/nilorg/ngin/model"
	"github.com/nilorg/sdk/convert"
)

var (
	// ErrBindNotIsJQueryDataTablesParameters ...
	ErrBindNotIsJQueryDataTablesParameters = errors.New("this struts not is JQueryDataTablesParameters")
)
